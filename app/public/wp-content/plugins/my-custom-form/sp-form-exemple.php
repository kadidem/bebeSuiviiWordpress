...
/*
Plugin Name:BebeSuivi Contact Form Plugin
...
*/
    ...
    function deliver_mail() {
        ...
        if ( isset( $_POST['cf-submitted'] ) ) {
            ...
            try {
                ...
                //Recipients
                $mail->setFrom('bamakosheraton@gmail.com','Bebe Suivi');
                $mail->addAddress($to);     //Add a recipient
        
                $headers = "From: $name <$email>" . "\r\n";

                $mail->addReplyTo($email, $name);
                $mail->Subject = 'Contact Bebe Suivi';
                $mail->isHTML(false);
                $mail->Body = <<<EOT
                E-mail: $email
                Nom: $name
    ...
    add_shortcode( 'BebeSuivi_contact_form', 'cf_shortcode' );
?>